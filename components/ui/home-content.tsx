  ...
  return (
    <div>
      <div className="background-image-cover" style={{backgroundImage:"url('" + bg1.src + "')"}}>
        <div style={{background: "rgba(255,125,50, 0.6); background: linear-gradient(90deg, rgba(255,125,50,0.6) 50%, rgba(255,255,255,0) 100%)"}}>
            ...
            <div className="row align-items-center min-vh-100">
              <div className="order-1 order-lg-0 col-lg-7 pb-5 pt-lg-5">
                <div className="text-center text-lg-start py-5 xl:tw-pe-[20px] xxl:tw-pe-[50px]">
                  <h1 className="rubik tw-font-[700] h-custom-1 px-4 px-md-0 mb-4">Deploy AI That’s Tailored<br className="d-none d-sm-block" /> to Your Needs</h1>
                  <p className="h-custom-4 px-sm-4 px-md-0 mb-5 pb-2">SparkPoint’s AI Deployment Services make it easy to integrate practical, cost-efficient automation into your business without the tech overwhelm.</p>

                  <div className="">
                    <a href="#" target="_blank" rel="noreferrer"
                       className="btn btn-custom-2 px-sm-4 px-md-5 px-lg-4 px-xl-5 py-3 h-custom-5 tw-rounded-[50px]">Get Your Complimentary AI Deployment Assessment</a>
                  </div>
                </div>
              </div>
            ...
            <div className="row justify-content-end align-items-center tw-min-h-[calc(100vh-78px)]">
              <div className="col-md-12 col-lg-10 py-5">
                <div className="text-center text-md-end pt-4 pb-5 py-sm-5">
                  ...
                  <p className="h-custom-4 px-4 px-md-0 mb-4">Manual work eats up time and slows growth. Most teams want
                    to<br/> use AI, but lack the in-house skills or resources to do it right.</p>
                  <p className="h-custom-4 px-4 px-md-0 mb-4">That’s where SparkPoint comes in. We take the stress out of
                    AI
                    deployment<br/> by building and training systems tailored to how you work.</p>
                  <p className="h-custom-4 px-4 px-md-0 mb-5 pb-2">Whether you&#39;re trying to automate support, improve
                    operations, or test AI-driven<br/> workflows, we get you up and running without the typical delays.
                  </p>

                  <div className="">
                    <a href="#" target="_blank" rel="noreferrer"
                       className="btn btn-custom-2 px-5 py-3 h-custom-5 tw-rounded-[50px]">Get Your Complimentary AI
                      Deployment Assessment</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container py-5">
              ...
              <div className="row align-items-center mb-4">
                ...
                <div className="col-lg-8 col-xl-9">
                  ...
                  <p className="text-center text-lg-start h-custom-4 mb-4">For teams with strict security needs, we provide
              ...
              <div className="row align-items-center mb-4">
                ...
                <div className="col-lg-8 col-xl-9">
                  ...
                  <p className="text-center text-lg-start h-custom-4 mb-4">Your business is unique. We train AI models using
              ...
              <div className="row align-items-center mb-5">
                ...
                <div className="col-lg-8 col-xl-9">
                  <div className="font-size-80">
                    <p className="text-center text-lg-start font-weight-500 tw-tracking-[-0.05em] tw-leading-[1.2em] lg:tw-leading-[1.1em] h-custom-2 px-4 px-md-0 mb-4">Team Training and Ongoing Support</p>
                  </div>

                  <p className="text-center text-lg-start h-custom-4 mb-4">We’ll show your team how to use, manage, and optimize your AI systems, and stick around to help when needed.</p>
                </div>
              </div>

              <div className="text-center">
                <a href="#" target="_blank" rel="noreferrer"
                   className="btn btn-custom-2 px-5 py-3 h-custom-5 tw-rounded-[50px]">Get Your Complimentary AI Deployment Assessment</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div
                ...
                <div className="h-100 w-100 d-flex align-items-center md:tw-px-[100px] lg:tw-px-[0]">
                  <div className="py-5 pe-lg-5 text-center text-lg-start">
                    <div className="py-5">
                      <p className="text-center text-lg-start font-weight-500 tw-tracking-[-0.05em] tw-leading-[1.2em] lg:tw-leading-[1.1em] h-custom-2 px-4 px-md-0 mb-5">Why Build With Us</p>
                      ...
                      <div className="d-flex flex-column flex-sm-row align-items-center mb-5">
                        ...
                        <div>
                          <p className="text-center text-sm-start h-custom-5 px-4 px-md-0 mb-0">We’ve been building in blockchain since 2018, with a track record rooted in product development, community engagement, and Web3 innovation.</p>
                        </div>
                      </div>
                      ...
                      <div className="d-flex flex-column flex-sm-row align-items-center mb-5">
                        ...
                        <div>
                          <p className="text-center text-sm-start h-custom-5 px-4 px-md-0 mb-0">Our AI deployment services build on that foundation, with practical solutions and clear support for projects that need to move fast without wasting time or money.</p>
                        </div>
                      </div>
      ...
      <div className="py-5 background-image-cover" style={{backgroundImage: "url('" + bg3.src + "')"}}>
        <div className="container py-5">
          <p className="text-center font-weight-500 tw-leading-[1em] h-custom-2 px-4 px-md-0 mb-5">Ready to See What AI Can Do for You?</p>
          <p className="text-center h-custom-5 mb-3">We’ll walk you through where AI fits into your business, what it can automate, and what kind of savings or workflow efficiency you can expect.</p>
          <p className="text-center h-custom-5 mb-5 pb-4">Click the button below to get a free AI deployment assessment.</p>

          <div className="text-center">
            <a href="#" target="_blank" rel="noreferrer"
               className="btn btn-custom-2 px-4 px-sm-5 py-3 h-custom-5 tw-rounded-[50px] tw-w-[100%] sm:tw-w-[initial]">I Want My Complimentary AI Deployment Assessment</a>
          </div>
        </div>
      </div>
    </div>
